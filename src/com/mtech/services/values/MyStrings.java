...
public class MyStrings {
	...
	public static final String APP_PACKAGE = "/com/mtech/services/";
	public static final String LOGIN = "Login";
	public static final String USER = "user";
	public static final String ADMIN = "admin";
	public static final String PASSWORD = "Password";
	public static final String MSG_USER_OR_PASS_INVALID = "user or password invalid";
	public static final String MAIN_TITLE = "Sistema para controle de OS";
	public static final String REGISTRATIO = "Registration";
	...
	public static final String DO_YOU_WANT_EXIT = "Do you want to exit the system?";
	public static final String DEVELOPED = "Developed by Monteiro neto";
	public static final String SERVICE_ORDER_CONTROL = "Service order control system";
	public static final String GPL_LICENSE = "GPL license";
	...
	public static final String ARE_YOU_SURE_REMOVE = "Are you sure you want to remove it?";
	 ...
	 * LINKS DE APOIO
	 * 
	 * +++link para biblioteca de pesquisa inteligente com o banco+++
